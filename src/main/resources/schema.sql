...
(
    ...
    vehicle_coefficient         NUMERIC(4, 2),
    special_vehicle_coefficient NUMERIC(4, 2),
    dms_coefficient             NUMERIC(4, 2)
);
...
CREATE TABLE IF NOT EXISTS age_dms_coefficient
(
    id          BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    age         INT CHECK (age >= 0 AND age <= 127) NOT NULL,
    coefficient NUMERIC                             NOT NULL
);
...
CREATE TABLE IF NOT EXISTS dms_base_rate
(
    id        BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    base_rate NUMERIC NOT NULL
);